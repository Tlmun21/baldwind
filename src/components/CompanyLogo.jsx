...
import meundies from "../assets/meundies.jpg";
      ...
      <div className="flex animate-marquee whitespace-nowrap">
        {logos.map((logo, index) => (
          <img
            ...
            src={logo}
            alt=""
            className="mx-12 h-16 w-64 object-contain grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all"
          />
        ))}
        {logos.map((logo, index) => (
          <img
            ...
            src={logo}
            alt=""
            className="mx-12 h-16 w-72 object-contain grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all"
          />
        ))}
      </div>
    </div>
