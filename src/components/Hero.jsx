  ...
  return (
    <section className="container mx-auto flex flex-col md:flex-row pt-44 pb-6 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full md:w-1/2 space-y-8">
        <div className="flex w-fit items-center gap-2 bg-gray-50 px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer group">
        ...
        <p className="text-gray-600 text-lg md:text-xl max-w-xl">
          Get the most accurate leads, sales peaple training and conversions,
          toold and more - all within the same one billing.
        </p>
